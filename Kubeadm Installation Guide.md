...
Step 1: Identify or Create a Security Group
  ...
  Create a New Security Group:
    ...
    Provide the following details:
      1.  Name: (e.g., Kubernetes-Cluster-SG)
      2.  Description: A brief description for the security group (mandatory)
      3.  VPC: Select the appropriate VPC for your instances (default is acceptable)
